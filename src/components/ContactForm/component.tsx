        ...
        <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                <Input
                    ...
                    error={!!formik.submitCount && formik.errors.firstname}
                    placeholder="Bruce"
                    label="First name"
                />
            </div>
            <div className="w-full md:w-1/2 px-3">
                <Input
                    ...
                    onChange={formik.handleChange}
                    error={!!formik.submitCount && formik.errors.lastname}
                    placeholder="Wayne"
                    label="Last name"
                />
            </div>
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">
                <Input
                    ...
                    onChange={formik.handleChange}
                    error={!!formik.submitCount && formik.errors.message}
                    label="Message"
